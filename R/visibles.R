  ...
  if (is.null(judgeit.object)) { #data loading stage.
    ...
    judgeit.object <-
      judgeit.setdata(xx,yy,wtv,wtt,wts,
                      ...
                      uncontested.low=uncontested.low,
                      uncontested.low.new=uncontested.low.new,uncontested.high=uncontested.high,
                      uncontested.high.new=uncontested.high.new, use.last.votes=use.last.votes)
...
`plot.judgeit.chopcollege` <- function(x, xlab=NULL, ylab=NULL, main=NULL, ...) with(x,{
